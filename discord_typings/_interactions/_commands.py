...
ApplicationCommandOptionData = Union[
    SubcommandOptionData,
    SubcommandGroupOptionData,
    ChoicesStringOptionData,
    AutocompleteStringOptionData,
    MinMaxStringOptionData,
    ChoicesIntegerCommandOptionData,
    MinMaxIntegerCommandOptionData,
    AutocompleteIntegerOptionData,
    BooleanOptionData,
    UserOptionData,
    ChannelOptionData,
    RoleOptionData,
    MentionableOptionData,
    ChoicesNumberCommandOptionData,
    MinMaxNumberCommandOptionData,
